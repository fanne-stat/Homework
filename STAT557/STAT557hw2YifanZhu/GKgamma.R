# This code is posted as GKgamma.R
# Enter a function for computing Goodman-Kruskal Gamma
...
# Apply the function to the Michigan data
# on attitudes toward proper behavior
